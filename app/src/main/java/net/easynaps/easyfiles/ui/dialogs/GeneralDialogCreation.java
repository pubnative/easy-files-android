...
import net.easynaps.easyfiles.adapters.HiddenAdapter;
import net.easynaps.easyfiles.adapters.data.LayoutElementParcelable;
import net.easynaps.easyfiles.asynchronous.asynctasks.CountItemsOrAndSizeTask;
import net.easynaps.easyfiles.asynchronous.asynctasks.GenerateHashesTask;
import net.easynaps.easyfiles.asynchronous.asynctasks.LoadFolderSpaceDataTask;
...
import net.easynaps.easyfiles.utils.FingerprintHandler;
...
import static net.easynaps.easyfiles.utils.files.FileUtils.toHybridFileArrayList;
