...
import net.easynaps.easyfiles.adapters.glide.RecyclerPreloadModelProvider;
import net.easynaps.easyfiles.adapters.glide.RecyclerPreloadSizeProvider;
import net.easynaps.easyfiles.adapters.holders.EmptyViewHolder;
import net.easynaps.easyfiles.adapters.holders.ItemViewHolder;
import net.easynaps.easyfiles.adapters.holders.SpecialViewHolder;
import net.easynaps.easyfiles.fragments.MainFragment;
import net.easynaps.easyfiles.ui.ItemPopupMenu;
...
import static net.easynaps.easyfiles.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORIZE_ICONS;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
     ...
     * @param imageView the check {@link net.pubnative.easyfiles.ui.views.CircleGradientDrawable} that is to be animated
     */
