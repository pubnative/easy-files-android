 ...
 * {@link net.easynaps.easyfiles.fragments.preference_fragments.PrefFrag#ENCRYPT_PASSWORD_MASTER}
 * and {@link net.easynaps.easyfiles.fragments.preference_fragments.PrefFrag#ENCRYPT_PASSWORD_FINGERPRINT}
...
public class CryptUtil {
    ...
    private static final String KEY_ALIAS_EASY_FILES = "EasyFilesKey";
    ...
    private static Key getSecretKey() throws GeneralSecurityException, IOException {
        ...
        if (!keyStore.containsAlias(KEY_ALIAS_EASY_FILES)) {
            KeyGenerator keyGenerator = KeyGenerator.getInstance(KeyProperties.KEY_ALGORITHM_AES, KEY_STORE_ANDROID);

            KeyGenParameterSpec.Builder builder = new KeyGenParameterSpec.Builder(KEY_ALIAS_EASY_FILES,
            ...
            return keyStore.getKey(KEY_ALIAS_EASY_FILES, null);
        }
    }
    ...
    static class RSAKeygen {
        ...
        private void generateKeyPair(Context context) throws GeneralSecurityException, IOException {
            ...
            if (!keyStore.containsAlias(KEY_ALIAS_EASY_FILES)) {
                ...
                KeyPairGeneratorSpec spec = new KeyPairGeneratorSpec.Builder(context)
                        .setAlias(KEY_ALIAS_EASY_FILES)
                        .setSubject(new X500Principal("CN=" + KEY_ALIAS_EASY_FILES))
        ...
        private byte[] encryptAESKey(byte[] secretKey) throws GeneralSecurityException, IOException {
            ...
            KeyStore.PrivateKeyEntry keyEntry = (KeyStore.PrivateKeyEntry)
                    keyStore.getEntry(KEY_ALIAS_EASY_FILES, null);
